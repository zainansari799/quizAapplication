...
function feedbackPage(){
    ...
    var feedbackpageshow = "<div class='quizcenter'><div id='question'><br><p style='font-size: 25px;'>Share your Views about Quizmaster!!</p><div id='comment'></div><br><form  onsubmit='feedback();'><textarea name='comments' cols='65' rows='7' placeholder='Enter your comments!!' id='feed'></textarea><br><input type='button' value='comment' onclick='feedback();' class='allbutton'></div></form></div></div><footer>CopyRight© Zain Ansari,2017</footer>";
...
function quizPage() {
    ...
    var quizespageshow ="<div class='quizcenter'><div id='question'><br><p style='font-size: 25px;'>Ask Questions!!</p><div id='askquestions'></div><br><form  onsubmit='askQuiz();'><textarea name='comments' cols='65' rows='7' placeholder='Ask questions!!' id='askquiz'></textarea><br><input type='button' value='Post' onclick='askQuiz();' class='allbutton'></div></form></div></div><footer>CopyRight© Zain Ansari,2017</footer>";
